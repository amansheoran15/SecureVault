...
export default function EditMoneyCard({ openModal, setOpenModal, cardData, handleCloseModal, handleUpdate }) {
    ...
    return (
        <>
            <Modal show={openModal} size="3xl" onClose={handleCloseModal} popup>
                <Modal.Header />
                <Modal.Body>
                    <h3 className="text-2xl font-medium text-gray-900 dark:text-white mb-8 text-center">Edit Card Details</h3>
                    ...
                    <div className="text-center grid">
                        ...
                        <div className="grid grid-cols-2 mt-4 gap-10">
                            <div className="text-left">
                                <div className="mb-2 block text-left">
                                    <Label htmlFor="expiry_date" value="Valid Thru"/>
                                </div>
