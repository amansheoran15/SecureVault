            ...
            <div id="form-container" className="flex flex-col items-center w-3/4 justify-center">
                <form className="flex max-w-md flex-col gap-4 w-full" onSubmit={handleSubmit(onSubmitCallback)}>
                    <div>
                        ...
                        {<TextInput id="text2" {...register("name", {
                            ...
                            minLength: {
                                ...
                                message: "Name must be of minimum length 4"
                                    ...
                                    placeholder="John Doe" type="text" shadow/>}
                    ...
                    <div>
                        ...
                        <TextInput id="email2" {...register("email", {
                            required: "This is a required field",
                            pattern: {
                                ...
                                message: 'Invalid email address',
                                   ...
                                   helperText={errors.email ? <> {errors.email.message}</> : undefined} type="email"
                                   placeholder="johndoe@example.com" shadow/>
                    </div>
                    <div>
                        <div className="mb-2 block">
                            <Label htmlFor="password2" value="Your password"/>
                        </div>
                        <TextInput id="password2" {...register("password", {
                            required: "This is a required field",
                            minLength: {
                                value: 8,
                                message: "Password must be at least 8 characters"
                                   ...
                                   type="password" shadow/>
                    </div>
                    <div>
                        <div className="mb-2 block">
                            <Label htmlFor="repeat-password" value="Repeat password"/>
                        </div>
                        <TextInput id="repeat-password" {...register("repeat_password", {
                            required: "This is a required field",
